...
BASEDIR=/home/2021/shan62/COMP512/P2/comp512p2
...
#TODO edit these entries to put the names of the servers and port numbers that you are using.
...
export process1=teach-node-05:410$group
export process2=teach-node-05:411$group
